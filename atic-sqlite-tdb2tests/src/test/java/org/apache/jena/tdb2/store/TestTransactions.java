...
public class TestTransactions
{
    ...
    */
    ...
    @Test public void trans_01() {
        //atic: added calculateRead for getNamedModel
        Model named = Txn.calculateRead(dataset, () -> {
            return dataset.getNamedModel(ns+"g");
        });
    ...
    @Test public void trans_02() {
        //atic: added calculateRead for getDefaultModel
        Model model = Txn.calculateRead(dataset, () -> {
